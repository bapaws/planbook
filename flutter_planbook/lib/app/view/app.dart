...
import 'package:flutter_planbook/app/activity/repository/ohos_app_hub_platform.dart';
        ...
        return AnnotatedRegion<SystemUiOverlayStyle>(
          ...
          child: MaterialApp.router(
            ...
            builder: (context, child) {
              ...
              final appHubConfig = _appHubConfig();
              return AppHubHost(
                client: kIsOhos
                    ? AppHubClient(
                        baseUrl: appHubConfig.baseUrl,
                        apiKey: appHubConfig.apiKey,
                        requireSign: appHubConfig.requireSign,
                        maxImages: appHubConfig.maxImages,
                        platform: OhosAppHubPlatform(),
                      )
                    : null,
                config: appHubConfig,
                fallbackAsset: 'assets/files/activity_messages.json',
                locale: _appHubLocaleTag(state.locale),
                // 鸿蒙商店沿用 Android 活动投放规则。
                platform: kIsOhos ? 'android' : null,
