...
extension NoteTypeX on NoteType {
  ...
  String noteTitle(Jiffy focusAt, AppLocalizations l10n) {
    ...
    return switch (this) {
      ...
      NoteType.weeklyFocus => l10n.weeklyFocusTitle(normalized.weekOfYear),
      NoteType.weeklySummary => l10n.weeklySummaryTitle(normalized.weekOfYear),
